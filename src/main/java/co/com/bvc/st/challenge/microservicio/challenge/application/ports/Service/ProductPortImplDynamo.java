...
@Service
public class ProductPortImplDynamo implements IProductPort {


    private IProductPersistencePort productPersistence;

    public ProductPortImplDynamo(@Qualifier("productDynamo") IProductPersistencePort productPersistence){
